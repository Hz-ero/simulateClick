(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["SplitPanel"] = factory();
	else
		root["SplitPanel"] = factory();
})(this, function() {
...
var _splitPanel = __webpack_require__(8);

var _splitPanel2 = _interopRequireDefault(_splitPanel);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _splitPanel2.default;
...
var getDomStyle = function getDomStyle(ele) {
  var style = ele.currentStyle ? ele.currentStyle : window.getComputedStyle(ele, null);

  return style;
};

var InitForwardComp = function InitForwardComp(props) {
...
var InitBackwardComp = function InitBackwardComp(props) {
  return _react2.default.createElement(
    'div',
    null,
    'backwardComp!'
...
var SplitPanel = function (_React$Component) {
  ...
  function SplitPanel(props) {
    ...
    _this.handleCleanPrevDrag = _this.handleCleanPrevDrag.bind(_this);
  ...
  _createClass(SplitPanel, [{
    ...
    value: function componentDidMount() {
      ...
      var totalWidth = Number.parseFloat(getDomStyle(dom).width);
      var totalHeight = Number.parseFloat(getDomStyle(dom).height);
      var splitSpacePer = 0;
    ...
    value: function onWindowResize(e) {
      ...
      var totalWidth = Number.parseFloat(getDomStyle(dom).width);
      var totalHeight = Number.parseFloat(getDomStyle(dom).height);
      var newForwardSapcePer = 0;
      var newBackwardSapcePer = 0;
      var _state = this.state,
          ifHorizontal = _state.ifHorizontal,
          splitSpace = _state.splitSpace,
          forwardSpacePer = _state.forwardSpacePer,
          backwardSpacePer = _state.backwardSpacePer;


      var prevTotalSpace = splitSpace * 100 / (100 - forwardSpacePer - backwardSpacePer);
    ...
    key: 'handleCleanPrevDrag',
    value: function handleCleanPrevDrag() {
      this.setState({
        prevDragValue: 0
      });
    }
    ...
    key: 'handleResize',
    value: function handleResize(dragValue) {
      var _this2 = this;
    ...
    value: function render() {
      ...
      var forwardComp = null;
      var backwardComp = null;
      if (!this.props.children) {
        forwardComp = _react2.default.createElement(InitForwardComp, null);
        backwardComp = _react2.default.createElement(InitBackwardComp, null);
...
/*
 ...
 LICENSE file in the root directory of this source tree.
*/
var f=__webpack_require__(4),p=__webpack_require__(5);__webpack_require__(6);var r=__webpack_require__(1);
...
*/
var aa=__webpack_require__(0);__webpack_require__(6);var l=__webpack_require__(12),n=__webpack_require__(4),ba=__webpack_require__(13),ca=__webpack_require__(1),da=__webpack_require__(5),ea=__webpack_require__(14),fa=__webpack_require__(15),ha=__webpack_require__(18),ia=__webpack_require__(19);
...
// module
exports.push([module.i, ".lib-index__wrapper--1SUEi {\n  flex: 1;\n  display: flex;\n  align-items: stretch;\n}", ""]);

// exports
exports.locals = {
	"wrapper": "lib-index__wrapper--1SUEi"
};
...
var DragBar = function DragBar(props) {
  ...
  var option = {
    ...
    // modules style
  };var moduleStyle = null;

  if (option.ifHorizontal) {
    moduleStyle = _index2.default.horizontalBar;
  } else {
    moduleStyle = _index2.default.verticalBar;
  }
...
// module
exports.push([module.i, ".lib-DragBar-index__horizontalBar--OVXhP {\n  background-color: rgb(52, 52, 54);\n  border-left: 1px solid rgba(255,255,255,0.1);\n  border-right: 1px solid rgba(0,0,0,0.4);\n  position: relative;\n}\n\n.lib-DragBar-index__horizontalBar--OVXhP:hover {\n  cursor: col-resize;\n}\n\n.lib-DragBar-index__verticalBar--196Ba {\n  background-color: rgb(52, 52, 54);\n  border-top: 1px solid rgba(255,255,255,0.1);\n  border-bottom: 1px solid rgba(0,0,0,0.4);\n  position: relative;\n}\n\n.lib-DragBar-index__verticalBar--196Ba:hover {\n  cursor: row-resize;\n}", ""]);

// exports
exports.locals = {
	"horizontalBar": "lib-DragBar-index__horizontalBar--OVXhP",
	"verticalBar": "lib-DragBar-index__verticalBar--196Ba"
};
...
var ResizePanel = function ResizePanel(props) {
  var domStyle = {
...
// module
exports.push([module.i, ".lib-ResizePanel-index__wrapper--3gg-- {\n  width: 100%; height: 100%;\n  padding: 0; margin: 0;\n  display: flex;\n}", ""]);

// exports
exports.locals = {
	"wrapper": "lib-ResizePanel-index__wrapper--3gg--"
};
